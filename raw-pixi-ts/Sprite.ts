...
export class Sprite extends Container
{
    ...
    _onTextureUpdate = ()=>
    {
        ...
        if (this._width)
        {
            this.scale.x = MathSettings.sign(this.scale.x) * this._width / this._texture.orig.width;
        }

        if (this._height)
        {
            this.scale.y = MathSettings.sign(this.scale.y) * this._height / this._texture.orig.height;
        }
    };
    ...
    */
     ...
     */
    static from = function from (source, options = {})
    {
        if(options == null)
        {   
            options = {}
